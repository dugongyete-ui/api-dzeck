...
class AIService:
    ...
    async def generate_response_stream(
        ...
        try:
            ...
            response = g4f.ChatCompletion.create_async(**kwargs)
    ...
    def _get_best_model_for_provider(self, provider_name: str) -> str:
        ...
        if provider_name in model_map:
            return model_map[provider_name]
